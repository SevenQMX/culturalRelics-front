...
function hotSpot_animateFun($new_li) {
    ...
    function hotspot_back() {
        ...
        $new_li.find(".icon_hotspot_back").css({
            "background": "url('" + window.parent.frontend_cdn_url + "../img/threed/icon_hotspot_pointbg.png') no-repeat",
...
function hotSpot_reset() {
    ...
    for (var i = 0; i < $hotSpotLi.length; i++) {
        ...
        console.log("getHotSpotPosition", getHotSpotPosition(id));
